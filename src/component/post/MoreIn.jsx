...
export const MoreIn = () => {
  return (
    <div className="ml-4 more-in max-w-md">
      <h2 className="text-2xl font-medium mb-6">More in Tech >></h2>
      <div className="flex w-[250px] h-[250px] pt-[20px] pr-[20px] pb-[20px] pl-[20px] flex-col gap-[10px] justify-center items-center shrink-0 flex-nowrap bg-[#d9d9d9] rounded-[10px] relative z-[160]">
        <div className="flex w-[210px] h-[210px] flex-col gap-[15px] justify-center items-start shrink-0 flex-nowrap relative z-[161]">
          <div className="flex w-[170px] gap-[12px] items-center shrink-0 flex-nowrap relative z-[162]">
            ...
            <div className="flex w-[118px] items-center shrink-0 flex-nowrap relative z-[166]">
              ...
              <div className="w-[71px] h-[25px] shrink-0 font-['Barlow'] text-[16px] font-light bg-[url(public/images/6607a5c7-0726-4478-90ba-2cdf162ce264.png)] bg-cover bg-no-repeat leading-[25px] relative z-[168]" />
            </div>
          </div>
          <div className="flex gap-[10px] items-start self-stretch shrink-0 flex-nowrap relative z-[169]">
            <span className="flex w-[220px] h-[72px] justify-start items-center shrink-0 font-['Barlow'] text-[18px] font-normal leading-[24px] text-[#000] tracking-[0.27px] relative text-left z-[170]">
              Lorem ipsum dolor sit amet, consectetur dsfd fdsfkj dsfd w4reij
              sdfa .......
            </span>
          </div>
