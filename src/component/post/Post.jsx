    ...
    <div className="container mx-auto px-4">
      <div className="flex justify-between items-center my-4">
        ...
        <div className="breadcrumbs">
          <span className="font-['Barlow'] text-[24px] font-medium leading-[36px] text-[#000] mr-2">
            Topics
          </span>
          <span className="font-['Barlow'] text-[24px] font-medium leading-[36px] text-[#000] mr-2">
            &gt;
        ...
        <div className="relative w-[316px]">
          <input
            ...
            style={{ paddingLeft: '60px' }}  // placeholder left side space between image
          />
          <div className="absolute left-0 top-1/2 transform -translate-y-1/2 pl-2">
            <div
              className="ml-4 w-[14px] h-[14.001px] bg-[url('/public/images/c1981ae0-b71a-49c6-a9e3-661ec3de8b53.png')] bg-contain bg-no-repeat"
            />
          </div>
        </div>
      </div>
