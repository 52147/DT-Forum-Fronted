...
export const PostComment = () => {
  return (
    <>
      ...
      <button className="flex w-[186px] pt-[6px] pr-[15px] pb-[6px] pl-[15px] gap-[5px] items-center flex-nowrap bg-[#000] rounded-[22px] border-none relative z-[359] pointer mt-[28.699px] mr-0 mb-0 ml-[709px] ">
        <span className="flex w-[156px] h-[24px] justify-center items-start shrink-0 basis-auto font-['Barlow'] text-[18px] font-normal leading-[24px] text-[#fff] tracking-[0.27px] relative text-center whitespace-nowrap z-[360]">
          Post your comment
        </span>
      </button>
    </>
