...
export const Slider = () => {
  return (
    <div>
      <div className="flex w-[1280px] gap-[51px] items-start flex-nowrap relative z-[17] mt-0 mr-0 mb-0 ml-[80px]">
        <button className="w-[514px] h-[332px] shrink-0 text-[0px] relative z-[18]">
          ...
          <div className="w-[514px] h-[332px] bg-[rgba(251,226,137,0.2)] bg-[url(../../assets/images/92b40de734d27a078108ff77c18f047e8fd43daa.png)] bg-cover bg-no-repeat rounded-[20px] absolute top-0 left-0 z-[19]" />
        </button>
        <button className="w-[332px] h-[332px] shrink-0 text-[0px] relative z-[21]">
          ...
          <div className="w-[332px] h-[332px] bg-[rgba(234,184,223,0.2)] bg-[url(../../assets/images/e941e42f82958bba4eceaa2c4b8efede3da6f9c4.png)] bg-cover bg-no-repeat rounded-[20px] absolute top-0 left-0 z-[22]" />
        </button>
        <button className="w-[332px] h-[332px] shrink-0 text-[0px] relative z-[24]">
          ...
          <div className="w-[332px] h-[332px] bg-[rgba(162,219,236,0.2)] bg-[url(../../assets/images/90a021840e3c058cf2f9160b8a56dc926a821139.png)] bg-cover bg-no-repeat rounded-[20px] absolute top-0 left-0 z-[25]" />
        </button>
        <div className="w-[449px] h-[332px] shrink-0 relative z-[27]">
          <button className="w-[436.117px] h-[332px] bg-[rgba(162,219,236,0.2)] bg-[url(../../assets/images/53da7f91712225075c21766ba12a388c3ba733d6.png)] bg-cover bg-no-repeat rounded-[20px] absolute top-0 left-0 z-[28]" >
